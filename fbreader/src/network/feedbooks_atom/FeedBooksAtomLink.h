...
#ifndef __FEEDBOOKSATOMLINK_H__
#define __FEEDBOOKSATOMLINK_H__

#include "../NetworkLink.h"

class FeedBooksAtomLink : public NetworkLink {
...
public:
	...
	shared_ptr<ZLNetworkData> resume(SearchResult &result);
};

#endif /* __FEEDBOOKSATOMLINK_H__ */
