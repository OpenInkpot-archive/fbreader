...
const std::string ActionCode::OK_ACTION = "okAction";
const std::string ActionCode::UP_ACTION = "upAction";
const std::string ActionCode::DOWN_ACTION = "downAction";
const std::string ActionCode::LEFT_ACTION = "leftAction";
const std::string ActionCode::RIGHT_ACTION = "rightAction";
const std::string ActionCode::DICT = "dictionary";
...
const std::string ActionCode::TURBO_TOGGLE = "toggleTurbo";
const std::string ActionCode::FONT_SIZE_DIALOG = "fontSizeDialog";
