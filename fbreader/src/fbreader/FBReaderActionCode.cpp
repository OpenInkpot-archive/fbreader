...
const std::string ActionCode::PAGE_SCROLL_FORWARD = "largeScrollForward";
const std::string ActionCode::PAGE_SCROLL_BACKWARD = "largeScrollBackward";
const std::string ActionCode::LINE_SCROLL_FORWARD = "smallScrollForward";
const std::string ActionCode::LINE_SCROLL_BACKWARD = "smallScrollBackward";
