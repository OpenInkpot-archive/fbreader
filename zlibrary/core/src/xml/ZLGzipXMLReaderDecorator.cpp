...
ZLGzipXMLReaderDecorator::ZLGzipXMLReaderDecorator(shared_ptr<ZLXMLAbstractReader> decoratee) : 
...
ZLGzipXMLReaderDecorator::ZLGzipXMLReaderDecorator(shared_ptr<ZLXMLAbstractReader> decoratee, size_t bufferSize) : 
