...
public:
	ZLGzipXMLReaderDecorator(shared_ptr<ZLXMLAbstractReader> decoratee);
	ZLGzipXMLReaderDecorator(shared_ptr<ZLXMLAbstractReader> decoratee, size_t bufferSize);
...
private:
	shared_ptr<ZLXMLAbstractReader> myDecoratee;
